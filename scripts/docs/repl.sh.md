...
This one is a major cheat, but if you run `+<Promise>` in the REPL, it'll automatically `await` the promise for you and print out the full (non-truncated) result.
