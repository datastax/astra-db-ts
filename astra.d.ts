...
declare namespace Components {
    ...
    namespace Schemas {
        export interface CommandResult {
             ...
             */
            data?: /* A response data holding documents that were returned as the result of a command. */ /* Response data for multiple documents commands. */ MultiResponseData | /* Response data for a single document commands. */ SingleResponseData;
            /**
            ...
            errors?: /* List of errors that occurred during a command execution. Can include additional properties besides the message that is always provided, like `errorCode`, `exceptionClass`, etc. */ Error[] | null;
        }
...
declare namespace Paths {
    namespace V1 {
        namespace Post {
            export type RequestBody = /* Command that create embedding service configuration. */ Components.Schemas.CreateEmbeddingServiceCommand | /* Command that creates a namespace. */ Components.Schemas.CreateNamespaceCommand;
            namespace Responses {
    ...
    namespace V1$Namespace {
        namespace Post {
            namespace Parameters {
                export type $0 = Components.Parameters.Namespace /* [a-zA-Z][a-zA-Z0-9_]* */;
            }
            export type RequestBody = /* Command that creates a collection. */ Components.Schemas.CreateCollectionCommand;
            namespace Responses {
                export type $200 = Components.Schemas.CommandResult;
            }
        }
    ...
    namespace V1$Namespace$Collection {
        namespace Post {
            namespace Parameters {
                export type $0 = Components.Parameters.Namespace /* [a-zA-Z][a-zA-Z0-9_]* */;
                export type $1 = Components.Parameters.Collection /* [a-zA-Z][a-zA-Z0-9_]* */;
            }
            export type RequestBody = /* Command that returns count of documents in a collection based on the collection. */ Components.Schemas.CountDocumentsCommands | /* Command that finds a single document and deletes it from a collection */ Components.Schemas.DeleteOneCommand | /* Command that finds documents based on the filter and deletes them from a collection */ Components.Schemas.DeleteManyCommand | /* Command that finds a single JSON document from a collection. */ Components.Schemas.FindOneCommand | /* Command that finds a single JSON document from a collection. */ Components.Schemas.FindCommand | /* Command that finds a single JSON document from a collection and deletes it. The deleted document is returned */ Components.Schemas.FindOneAndDeleteCommand | /* Command that finds a single JSON document from a collection and replaces it with the replacement document. */ Components.Schemas.FindOneAndReplaceCommand | /* Command that finds a single JSON document from a collection and updates the value provided in the update clause. */ Components.Schemas.FindOneAndUpdateCommand | /* Command that inserts a single JSON document to a collection. */ Components.Schemas.InsertOneCommand | /* Command that inserts multiple JSON document to a collection. */ Components.Schemas.InsertManyCommand | /* Command that finds documents from a collection and updates it with the values provided in the update clause. */ Components.Schemas.UpdateManyCommand | /* Command that finds a single JSON document from a collection and updates the value provided in the update clause. */ Components.Schemas.UpdateOneCommand;
            namespace Responses {
                export type $200 = Components.Schemas.CommandResult;
            }
        }
