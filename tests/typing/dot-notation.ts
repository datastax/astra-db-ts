...
import type { BasicSchema, ConvolutedSchema1, ConvolutedSchema3, Equal, Expect, Schema } from '@/tests/typing/prelude.js';
import type { ToDotNotation } from '@/src/documents/collections/types/index.js';
