...
import { processCodecs, RawCollCodec, CollCodecs, CollCodec } from '@/src/documents/collections/ser-des/codecs';
import { $DeserializeForCollection, $SerializeForCollection } from '@/src/documents';
      ...
      assert.deepStrictEqual(processed, [
        {
          ...
          forPath: [
            ...repeat((i) => ({ path: ['pa', 'th', `${i}`], fns: [`path${i}:ser_fn`, `path${i}:serdes_fn`] })),
          ],
          forClass: [
        ...
        },
        {
          ...
          forPath: [
            ...repeat((i) => ({ path: ['pa', 'th', `${i}`], fns: ['$DeserializeForCollection', `path${i}:des_fn`, `path${i}:serdes_fn`] })),
          ],
          forType: {
