...
// import { CursorError, CursorStatus } from '@/src/documents/cursors/abstract-cursor.js';
//
...
//    * @internal
//    */
//   protected constructor(parent: Table<SomeRow> | Collection, serdes: SerDes, filter: [SerializedFilter, boolean], options?: GenericFindOptions, mapping?: (doc: TRaw) => T) {
//     this.#parent = parent;
