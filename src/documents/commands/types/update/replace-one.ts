...
export interface ReplaceOneOptions extends WithTimeout {
  ...
  sort?: Sort,
  /**
   * An optional vector to use of the appropriate dimensionality to perform an ANN vector search on the collections
 ...
 * @example
 * ```typescript
 * const result = await collections.replaceOne({
 *   _id: 'abc'
 * }, {
 *   name: 'John'
 * }, {
