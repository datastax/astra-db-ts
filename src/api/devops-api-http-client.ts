...
import { BlockingOptions } from '@/src/devops/types';
...
export class DevopsApiHttpClient extends HttpClient {
  ...
  public async awaitStatus(idRef: { id: string }, target: string, legalStates: string[], options: BlockingOptions | undefined, defaultPollInterval: number): Promise<void> {
